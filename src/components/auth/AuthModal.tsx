...
export default function AuthModal({ onClose }: AuthModalProps) {
  ...
  return (
    <div className="h-full fixed inset-50 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
        ...
        <div className="relative w-full max-w-sm mx-4 bg-bg border border-border-subtle rounded-xl shadow-2xl">
          ...
          <div className="p-6">
            ...
            <div className="flex items-center gap-3 my-5">
              ...
              <span className="text-sm text-ink3">{t('auth.or')}</span>
              <div className="flex-1 h-px bg-border-subtle" />
            </div>

            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-sm text-ink3 mb-1.5">{t('auth.email')}</label>
                <input
                  type="email"
                  value={email}
              ...
              <div>
                <label className="block text-sm text-ink3 mb-1.5">{t('auth.password')}</label>
                <input
                  type="password"
                  value={password}
