...
for (const line of lines) {
  ...
  if (match) {
    ...
    const styleMatch = line.match(/(Country blues|Delta blues|Chicago blues|Piedmont blues|Memphis blues|Texas blues|West Coast blues|Electric blues|Boogie woogie|Classic female blues|Vaudeville blues|Acoustic blues|Gospel blues|Jump blues|Soul blues|Swamp blues|British blues|Blues rock)/i);
    if (styleMatch) {
